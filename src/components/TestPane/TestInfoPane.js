...
const MESSAGES = {
	...
	'temperature (deg C)': "Temperature impacts the rates of metabolism and growth of aquatic organisms, rate of plants' photosynthesis, solubility of oxygen in river water, and organisms' sensitivity to disease, parasites, and toxic materials. At a higher temperature, plants grow and die faster, leaving behind matter that requires oxygen for decomposition.",
	'depth (cm)': "The depth of a river is an indicator of many factors including: rain that year,groundwater depletion or an obstruction in the course of the river.",
